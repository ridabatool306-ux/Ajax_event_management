                  ...
                  <h3><?php echo @$msg?></h3>
                    ...
                    <div class="card-body">
                      <div class="">
                           ...
                           <input type="hidden" class="form-control"   value="<?php echo $tfet['booking_id'] ?>" name="id">
                       </div>
                    <div class="mb-3">
                    <label for="" class="ml-2">Select Category*</label><br>
                    ...
                    <option value="<?php echo $tfet['venue_id'];?>"><?php echo $tfet['venuename'];?></option>
                    <?php
                    ...
                    ?>
                      ...
                      <?php
                            if ($tfet['occassiontype'] == "public") {
                                $check_public = "checked";
                            } else if($tfet['occassiontype'] == "private"){
                                $check_private = "checked";
                            }
                            ?>
                        
                        <input type="radio" name="occassiontype"  <?php echo  @$check_public ?>  value="public"> Public
                       <input type="radio" name="occassiontype"  <?php echo  @$check_private ?>  value="private"> Private
            ...
            $.ajax({
              ...
              success:function(res){
                ...
                if(res==1){
                  ...
                  alert("data updated");
                  window.location.replace("./bookingview.php");
                }else if(res==2){
