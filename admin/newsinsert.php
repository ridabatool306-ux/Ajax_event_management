                  ...
                  <h3><?php echo @$msg?></h3>
                    ...
                    ?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="newstitle" placeholder="Enter Event Title">
                      </div>  
                      <div class="form-group ">
                        <label>Description*</label>
                        <textarea class="form-control" required="" name="newsdescription">Enter Description Here....</textarea>
                      </div>
                      <div class="form-group">
                        <label>Featured Images</label><br>
                        <input type="file" class="form-control" multiple name="newspic[]" placeholder="" />
                    </div>
