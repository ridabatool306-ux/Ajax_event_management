                ...
                <div class="card">
                  <form id="update_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control"name="id" value="<?php echo $tfet['planner_id']?>" >
                      </div>
                    <div class="card-body">
                      <div class="form-group">
                      ...
                      <label >Gender*</label>
                      <?php
                            if ($tfet['plannergender'] == "male") {
                                $check_male = "checked";
                            } else if($tfet['plannergender'] == "female"){
                        ...
                        <input type="radio" name="plannergender" <?php echo  @$check_male ?> value="male"> male
                       <input type="radio" name="plannergender" <?php echo  @$check_female ?> value="female"> female
                      <input type="radio" name="plannergender"  <?php echo  @$check_others ?> value="others"> others
                      ...
                      <div class="form-group ">
                        ...
                        <textarea class="form-control" required="" value="" name="planneraddress"><?php echo $tfet['planneraddress']?></textarea>
                      </div>
                      <div class="form-group">
                    ...
                    <input type="submit" id="btn_update" name="sub" value="update" style="border-radius:5px; border:2px solid black; font-weight:bold; background-color:blue;color:white;padding:10px;">
                    </div>
                  </form>
                </div>
